...
[下载 Codex Beacon 1.0.8](https://github.com/lindengjian/CodexBeacon/releases/tag/v1.0.8)
...
1. 下载并打开 `CodexBeacon-1.0.8-arm64.dmg`。
...
- 支持标准尺寸（`62 × 229 pt`）、紧凑尺寸（`24 × 88 pt`）、可设置的全局快捷键、登录时启动、亮/暗/跟随系统外观，以及为“审批”“已完成”“额度重置”分别配置声音。
